...
print("TEST 3854:", resp.status_code, resp.text)

payload["dmpc_ref"][0]["dmpc_ref"] = "3854A"
resp = requests.post(url, headers=get_headers(), json=payload)
print("TEST 3854A:", resp.status_code, resp.text)

payload["dmpc_ref"][0]["dmpc_ref"] = "03854"
resp = requests.post(url, headers=get_headers(), json=payload)
print("TEST 03854:", resp.status_code, resp.text)

payload["dmpc_ref"][0]["dmpc_ref"] = "3854 "
resp = requests.post(url, headers=get_headers(), json=payload)
print("TEST 3854_:", resp.status_code, resp.text)
